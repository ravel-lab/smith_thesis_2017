...
qPCR_time_course<-filter(qPCR_time_course,!(BCS=="DL_10" & ExposureTime=="0.5hr"))
qPCR_time_course
...
qpcr_sigtest<-qpcr_sigtest[!(qpcr_sigtest$ExposureTime=="0.5hr" & qpcr_sigtest$comparison=="DL_10"),]
