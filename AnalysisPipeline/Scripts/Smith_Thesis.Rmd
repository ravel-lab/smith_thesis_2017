...
##model_input_Lactobacillus$LACTO_PROP<-as.numeric(model_input_Lactobacillus$LACTO_PROP)
...
Nugent_RF.Boruta<-Boruta(x=dplyr::select(model_input_Lactobacillus,-c(SID,LACTO_PROP)),y=model_input_Lactobacillus$LACTO_PROP)
