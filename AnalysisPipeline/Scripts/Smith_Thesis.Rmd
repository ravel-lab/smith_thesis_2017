...
nd<-read.table("~/Desktop/new_qpcr_data.txt",header = T,sep = "\t")

qPCR_time_course<-rbind.fill(nd,qPCR_time_course)
...
qPCR_time_course.summary[!is.na(qPCR_time_course.summary$sd_193b),]
