...
TABLE_RF_SUMMARY<-"TABLE_S4.csv"
TABLE_MIR_TARGETS<-"TABLE_S5.txt"
TABLE_QPCR_TIMECOURSE<-"TABLE_S6.csv"
TABLE_EDU_SCRATCH_QUANT<-"TABLE_S7.csv"
TABLE_WESTERN_QUANT<-"TABLE_S8.csv"
TABLE_CT_QUANT<-"TABLE_S9.csv"
TABLE_TRL_ALIGNSTATS<-"TABLE_S10.csv"
TABLE_TRL_COUNTS_RAW<-"TABLE_S11.csv"
TABLE_EDGER_RESULTS<-"TABLE_S12.csv"
TABLE_TRL_PATHWAY_Z_SCORES<-"TABLE_S13.csv"
