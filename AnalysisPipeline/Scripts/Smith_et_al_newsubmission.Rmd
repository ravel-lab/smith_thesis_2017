...
root_directory<-"~/Documents/smith_thesis_2017/AnalysisPipeline/"#"~/Dropbox (IGS)/Jacques_Steve_Shared/Thesis/Thesis_pipeline/AnalysisPipeline/"
...
TABLE_TRL_ALIGNSTATS<-"TABLE_3.csv"
TABLE_TRL_NUMDEGENES<-"TABLE_4.csv"
TABLE_TRL_SUMMARY_PATHWAYS<-"TABLE_5.csv"
...
TABLE_TRL_COUNTS_RAW<-"TABLE_S12.csv"
TABLE_EDGER_RESULTS<-"TABLE_S13.csv"
TABLE_TRL_PATHWAY_Z_SCORES<-"TABLE_S14.csv"

FIGURE_SUBJECT_PLOTS<-"FIGURE_1_"
#FIGURE_RF_IMPORTANCE_AMSEL<-"FIGURE_2_A.eps"
FIGURE_RF_IMPORTANCE_NUGENT<-"FIGURE_2_B.eps"
FIGURE_TOPMIRS<-"FIGURE_2_C.eps"
FIGURE_QPCR_TIMECOURSE<-"FIGURE_3.eps"
FIGURE_EDU_QUANT<-"FIGURE_4_D.eps"
FIGURE_SCRATCH_QUANT<-"FIGURE_4_C.eps"
FIGURE_CT_INFECT_QUANT<-"Figure_4_G.eps"
FIGURE_CT_EDU_QUANT<-"Figure_4_F.eps"
FIGURE_TRANSFECT<-"Figure_5.eps"
FIGURE_COMBINED_PATHWAYS_CYCLE<-"Figure_6.eps"
FIGURE_LONGITDUINAL_GENEEXP.cycle<-"Figure_7.eps"
FIGURE_FINAL_MODEL<-"Figure_8.eps" ##Placeholder
...
FIGURE_DL_LACTICACID_QPCR<-"Figure_S3.eps"
FIGURE_nyc_v_tsb<-"Figure_S5.eps"
#FIGURE_TRL_RIN_HIST<-"Figure_S6.eps"
...
group_go_map<-merge(group_go_map,mir_go.wide.filtered.summary,all=T)
...
PLOT_QPCR_TIMECOURSE<-
 # ggplot(filter(qpcr_sigtest,reference=="G. vaginalis" &
   ggplot(filter(qpcr_sigtest,reference=="Cell Culture Medium" &
                   comp %in% c("L. crispatus","L. jensenii","L. iners","G. vaginalis")&
  ...
  geom_line(size=1.5,show.legend = T)+#,aes(linetype="3"))+ 
