...
TABLE_WESTERN_QUANT<-"TABLE_S11.csv"
TABLE_CT_QUANT<-"TABLE_S12.csv"
TABLE_TRL_ALIGNSTATS<-"TABLE_S13.csv"
TABLE_TRL_COUNTS_RAW<-"TABLE_S14.csv"
TABLE_EDGER_RESULTS<-"TABLE_S15.csv"
TABLE_TRL_PATHWAY_Z_SCORES<-"TABLE_S16.csv"
...
lapply(fitness,FUN=function(x) fitness[[x]][1]$coefficients[2])
lapply(fitness,unname)
