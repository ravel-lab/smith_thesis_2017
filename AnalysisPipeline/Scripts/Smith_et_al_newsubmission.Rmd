...
## FIXME
## This needs to happen before so that SRL_counts_meta contains filtered list since pData(SRL_counts_meta) is used in some of the stats calculations. 
## Intersect data for which both 16S rRNA seq and small RNAseq data exist
taxa_data_dne<-is.na(SRL_meta_table$CST)
sum(taxa_data_dne)
SRL_meta_table<-SRL_meta_table[!taxa_data_dne,]
