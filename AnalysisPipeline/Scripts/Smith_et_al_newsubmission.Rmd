...
## Scratch & EdU on same figure? 13h scratch & EdU microscopy (A, B) and quants (C, D) as bar graphs
FIGURE_CT_INFECT_QUANT<-"Figure_4_G.eps"
FIGURE_CT_EDU_QUANT<-"Figure_4_F.eps"

FIGURE_COMBINED_PATHWAYS_CYCLE<-"Figure_5.eps"
FIGURE_LONGITDUINAL_GENEEXP.cycle<-"Figure_6.eps"
FIGURE_FINAL_MODEL<-"Figure_7.eps" ##Placeholder
