...
mir193b_GOcount_groups.plot<-ggplot(mir_group.mir193b.summary,aes(x=Group,y=n))+geom_bar(width=.7,position = "dodge",col="grey",stat="identity")+
  journalFormat+
  theme(axis.text.x = element_text(angle=45,hjust = 1),text=element_text(size=25),plot.margin = unit(c(10,25,10,170),units = "pt"))+
  scale_fill_brewer(type = "qual",palette = "Set1")+
...
mir_go.mir193b.summary$Go_format<-factor(mir_go.mir193b.summary$Go_format,levels = mir_go.mir193b.summary[order(mir_go.mir193b.summary$Group,decreasing = F),"Go_format"],ordered = T)

mir193b_GOcount.plot<-ggplot(mir_go.mir193b.summary,aes(x=Go_format,y=n,fill=Group))+geom_bar(width=.7,position = "dodge",col="grey",stat="identity")+
  journalFormat+
  theme(axis.text.x = element_text(angle=45,hjust = 1,size=10),text=element_text(size=12),plot.margin = unit(c(10,25,10,170),units = "pt"))+
  scale_fill_brewer(type = "qual",palette = "Set1")+
  xlab("GO Term")+
